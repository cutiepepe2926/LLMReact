...
const ProjectDashboardPage = ({ onBack, onEnterReport }) => {
  return (
      ...
      <section className="project-header">
        <div>
          <div className="title-row">
            {/* 뒤로가기 버튼 추가 */}
            <button onClick={onBack} style={{ marginRight: '10px', cursor: 'pointer', background: 'none', border: 'none', fontSize: '1.2rem' }}>←</button>
